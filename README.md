...
Out of 312 miRNAs, 152 achieved acceptable predictive performance on the test set (R² > 0.4), with a median R² of 0.82 in scRNA-seq data and 0.77 in bulk test data.
